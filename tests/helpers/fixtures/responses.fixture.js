...
export const responseFixtures = {
    ...
    ragResponse: {
        answer: 'Los requisitos de KYC para clientes nuevos incluyen: 1) Verificación de identidad mediante documento oficial, 2) Comprobante de domicilio no mayor a 3 meses, 3) Cuestionario de conocimiento del cliente, 4) Análisis de perfil de riesgo en el sistema Efisys.',
        sources: [
            {
    ...
    emptyResponse: {
        answer: 'No se encontraron documentos relevantes para responder tu consulta. Por favor, intenta reformular tu pregunta o contacta a un especialista.',
        sources: [],
        contextoUsado: [],
    },
    conversationHistory: [
        ...
        },
        {
            id: 'msg-2',
            role: 'assistant',
            content: 'KYC (Know Your Customer) es el proceso de identificación y verificación de clientes...',
 ...
 */
export const createTestSources = (count = 3) => {
